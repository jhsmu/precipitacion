...
<main>
        ...
        <h1 class="animated-element" style="font-size: 1.5em">IchoClimaOnline</h1>
        <h2 class="animated-element" style="font-size: 35px">Bienvenido a IchoClimaOnline, tu fuente confiable de datos meteorológicos en línea. En un mundo donde el clima desempeña un papel crucial en nuestras vidas cotidianas, estamos aquí para proporcionarte información precisa y actualizada sobre un aspecto esencial: la precipitación. </h2>
        </section>
